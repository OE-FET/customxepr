...
folder = '/home/ss2151/Dropbox/ESR_data_upload/FI_ESR_pBTTT/OOP_run3/'
...
for T in [20, 10, 5]:
    ...
    if T in [5, 20, 50, 80, 140, 200, 260, 290]:
        for volt in [0, Vg]:
            ...
            if T <= 80:
                customXepr.pause(3*60)
            customXepr.runExperiment(Pwrst, ModAmp=modAmp[T], PowerAtten=atten[T], SweepWidth=sweepWidth[T], NbScansToDo=nbScansPwrst[T])
            customXepr.biasGate(0)
