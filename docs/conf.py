...
version = get_metadata("../customxepr/__init__.py", "__version__")
# The full version, including alpha/beta/rc tags
release = get_metadata("../customxepr/__init__.py", "__version__")
...
latex_documents = [
    (master_doc, "CustomXepr.tex", "CustomXepr Documentation", "Sam Schott", "manual"),
]
...
man_pages = [(master_doc, "CustomXepr", "CustomXepr Documentation", [author], 1)]
